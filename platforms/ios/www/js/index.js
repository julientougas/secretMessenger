...
var app = {
    ...
    //runs when you press the register button
    ...
    //runs when opening the message list modal
    , display: function () {
        //send (open modal, close modal)
        ...
        fetch(req).then(function (response) {
            ...
            console.log(data);
            //if there are no errors data.code will be 0
            if (data.code == 0) {
                if (data.messages.length != 0) {
                    var ul = document.querySelector('#msgList');
                    ul.innerHTML = "";
                    //creates the html messages
    ...
    //runs when opening the send picture modal
    , picture: function (ev) {
        app.openCloseModal('#picModal', '#delModal');
        app.openCloseModal('#picModal', '#listModal');
        //hide all elements if you haven't taken a picture
    ...
    //runs when taking the take picture button
    , takePic: function (ev) {
        ev.preventDefault();
    ...
    , successCallback: function (imageURI) {
        ...
        //display html elements after picture is taken
    ...
    //runs when you press the delete button
    , delete: function (ev) {
        ev.preventDefault();
        app.openCloseModal('#listModal', '#delModal');
    ...
    //runs when you go back from the showMsg modal
    , back: function () {
        console.log("back");
        var c = document.querySelector("#delCanvas");
        var ctx = c.getContext('2d');
